        ...
        <div id="carouselThree" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="<?php echo get_template_directory_uri() . '/assets/images/slider/1.png'?>" alt="Hero">
                        </div> <!-- slider-imgae -->
                ...
                <div class="carousel-item">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="<?php echo get_template_directory_uri() .'/assets/images/slider/2.png'?>" alt="Hero">
                        </div> <!-- slider-imgae -->
                    </div> <!-- slider-imgae box -->
                </div> <!-- carousel-item -->
                ...
                <div class="carousel-item">
                    ...
                    <div class="slider-image-box d-none d-lg-flex align-items-end">
                        <div class="slider-image">
                            <img src="<?php echo get_template_directory_uri() . '/assets/images/slider/3.png'?>" alt="Hero">
                        </div> <!-- slider-imgae -->
                    </div> <!-- slider-imgae box -->
                </div> <!-- carousel-item -->
            </div>
                    ...
                    <div class="single-features mt-40">
                        <div class="features-title-icon d-flex justify-content-between">
                            ...
                            <div class="features-icon">
                                ...
                                <img class="shape" src="<?php echo get_template_directory_uri(). '/assets/images/f-shape-1.svg'?>" alt="Shape">
                            </div>
                        </div>
                ...
                <div class="col-lg-9 col-md-9">
                    <div class="row no-gutters grid mt-50">
                        <div class="col-lg-4 col-sm-6 branding-4 planning-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?php echo get_template_directory_uri() . '/assets/images/portfolio/1.png'?>" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?php echo get_template_directory_uri() . '/assets/images/portfolio/1.png'?>"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?php echo get_template_directory_uri() . '/assets/images/portfolio/shape.svg'?>" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                        ...
                        <div class="col-lg-4 col-sm-6 marketing-4 research-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?php echo get_template_directory_uri() . '/assets/images/portfolio/2.png'?>" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?php echo get_template_directory_uri(). '/assets/images/portfolio/2.png'?>"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?php echo get_template_directory_uri() . '/assets/images/portfolio/shape.svg'?>" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 branding-4 marketing-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?php echo get_template_directory_uri() . '/assets/images/portfolio/3.png'?>" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?php echo get_template_directory_uri() .'/assets/images/portfolio/3.png'?>"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?php echo get_template_directory_uri() . '/assets/images/portfolio/shape.svg'?>" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 planning-4 research-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?php echo get_template_directory_uri() .'/assets/images/portfolio/4.png'?>" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?php echo get_template_directory_uri() .'/assets/images/portfolio/4.png'?>"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?php echo get_template_directory_uri(). '/assets/images/portfolio/shape.svg'?>" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 marketing-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?php echo get_template_directory_uri() . '/assets/images/portfolio/5.png'?>" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?php echo get_template_directory_uri() .'/assets/images/portfolio/5.png'?>"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?php echo get_template_directory_uri() .'/assets/images/portfolio/shape.svg'?>" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 planning-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?php echo get_template_directory_uri(). '/assets/images/portfolio/6.png'?>" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?php echo get_template_directory_uri() .'/assets/images/portfolio/6.png'?>"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?php echo get_template_directory_uri() .'/assets/images/portfolio/shape.svg'?>" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 research-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?php echo get_template_directory_uri() .'/assets/images/portfolio/7.png'?>" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?php echo get_template_directory_uri() .'/assets/images/portfolio/7.png'?>"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?php echo get_template_directory_uri() .'/assets/images/portfolio/shape.svg'?>" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 branding-4 planning-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?php echo get_template_directory_uri() .'/assets/images/portfolio/8.png'?>" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?php echo get_template_directory_uri() .'/assets/images/portfolio/8.png'?>"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?php echo get_template_directory_uri() .'/assets/images/portfolio/shape.svg'?>" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
                        ...
                        <div class="col-lg-4 col-sm-6 marketing-4">
                            <div class="single-portfolio">
                                <div class="portfolio-image">
                                    <img src="<?php echo get_template_directory_uri() .'/assets/images/portfolio/9.png'?>" alt="">
                                    <div class="portfolio-overlay d-flex align-items-center justify-content-center">
                                        <div class="portfolio-content">
                                            <div class="portfolio-icon">
                                                <a class="image-popup" href="<?php echo get_template_directory_uri(). '/assets/images/portfolio/9.png'?>"><i class="lni lni-zoom-in"></i></a>
                                                <img src="<?php echo get_template_directory_uri() .'/assets/images/portfolio/shape.svg'?>" alt="shape" class="shape">
                                            </div>
                                            <div class="portfolio-icon">
                                                <a href="#"><i class="lni lni-link"></i></a>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="<?php echo get_template_directory_uri() .'/assets/images/pro.svg'?>" alt="">
                        </div>
                        <div class="pricing-header text-center">
                ...
                <div class="col-lg-4 col-md-7 col-sm-9">
                    <div class="pricing-style mt-30">
                        <div class="pricing-icon text-center">
                            <img src="<?php echo get_template_directory_uri() .'/assets/images/enterprise.svg'?>" alt="">
                        </div>
                        <div class="pricing-header text-center">
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    <div class="about-image mt-50">
                        <img src="<?php echo get_template_directory_uri() .'/assets/images/about.jpg'?>" alt="about">
                    </div> <!-- faq image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
                        ...
                        <div class="testimonial-content-wrapper testimonial-active">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                            <img src="<?php echo get_template_directory_uri() .'/assets/images/author-1.jpg'?>" alt="author">
                                        </div>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                                <img src="<?php echo get_template_directory_uri() .'/assets/images/author-2.jpg'?>" alt="author">
                                        </div>
                                        <div class="author-name media-body">
                                            <h5 class="name">Mr. Jems Bond</h5>
                                            <span class="sub-title">CEO Mbuild Firm</span>
                            ...
                            <div class="single-testimonial">
                                ...
                                <div class="testimonial-author d-sm-flex justify-content-between">
                                    <div class="author-info d-flex align-items-center">
                                        <div class="author-image">
                                                <img src="<?php echo get_template_directory_uri() .'/assets/images/author-3.jpg'?>" alt="author">
                                        </div>
                                        <div class="author-name media-body">
                                            <h5 class="name">Mr. Jems Bond</h5>
                                            <span class="sub-title">CEO Mbuild Firm</span>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="team-style-eleven text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0s">
                        <div class="team-image">
                            <img src="<?php echo get_template_directory_uri() .'/assets/images/team-1.jpg'?>" alt="Team">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="team-style-eleven text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0s">
                        <div class="team-image">
                            <img src="<?php echo get_template_directory_uri() .'/assets/images/team-2.jpg'?>" alt="Team">
                        </div>
                        <div class="team-content">
                            <div class="team-social">
                                <ul class="social">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="team-style-eleven text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0s">
                        <div class="team-image">
                            <img src="<?php echo get_template_directory_uri() .'/assets/images/team-3.jpg'?>" alt="Team">
                        </div>
                        <div class="team-content">
                            <div class="team-social">
                                <ul class="social">
